...
| v6 | `approach2_v6_20260910_1505` | **최종 극대화 후보**: v5(approach2_v5_20260910_1453)의 16모델 배깅 원시 확률 × **3차의 복원 배율**(STES 0.5, LUSC 2.0, SARC 3.0, THYM 2.5 …) + 쌍둥이 규칙. 3차의 결정 규칙을 그대로 쓰고 예측 분산만 줄임 (후처리 전용 스크립트) | 0.4691 (모델 동일) | 제출 후보 |
