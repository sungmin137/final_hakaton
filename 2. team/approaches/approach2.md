...
| v7 | `approach2_v7_20260910_1651` | **mild**: 3차 구성 + XGB colsample_bytree 0.7 (다른 것 동일, 복원 배율·규칙) | - | 제출 후보 |
| v8 | `approach2_v8_20260910_1651` | **mild**: 3차 구성 − 접근 1 변이 단위 점수(cw_variant_*) (유전자 단위 점수 유지) | - | 제출 후보 |
