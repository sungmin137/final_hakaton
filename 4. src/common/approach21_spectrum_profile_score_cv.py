"""호환 파일: 접근16의 아미노산 치환 필체 NB 검증 코드.

초기 작업명 `approach21`을 팀에서 찾을 수 있도록 경로를 유지한다.
공식 실험명과 최신 설명은 접근16이다.
...
def main() -> None:
    ...
    parser.add_argument("--out", type=Path, default=REPO / "6. experiments/2026-09-15_spectrum_profile_score")
