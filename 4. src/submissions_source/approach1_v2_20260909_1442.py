...
재현: python3 "4. src/submissions_source/approach1_v2_20260909_1442.py"  →  5. submissions/approach1_v2_20260909_1442.csv (+ _twin_rule 변형본)
설정: --features v2 
설명 문서: 2. team/approaches/approach1.md
"""
import sys
