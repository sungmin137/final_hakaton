...
| 6차 | approach5_v1_20260909_2135.csv | 접근5 v1 통합: 접근1+2+4 피처 + 접근3 블렌딩 + 클래스 배율 | 0.4916(낙관)+배율 | 0.412 |
| 7차 | approach5_v2_20260909_2322.csv | 접근5 v2: v5 피처 + 클래스 배율 (블렌딩 제외) | 0.4761 + 배율 | 0.412 |
