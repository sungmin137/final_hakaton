...
| 규칙 | 우리 코드 | 근거 위치 | 판정 |
|---|---|---|---|
| test를 학습에 사용 금지 | test.csv는 `load_test()` 한 곳에서만 읽고, 호출은 추론 함수 안에서만 | `src/common/main.py` load_test / fit_full_and_submit, `src/common/make_submission.py` | ✅ |
...
구현: `src/common/approach2_knowledge/knowledge_features.py` (BLOSUM62 + 아미노산 특성 변화량). 출처: Henikoff & Henikoff 1992 (BLOSUM62), Kyte & Doolittle 1982 (소수성), Zamyatnin 1972 (잔기 부피).
