...
| 2026-09-10 | 접근10 혼동 암종 쌍 재판기 | V4 상위 2개가 고정 혼동 쌍이며 확률 차이≤0.30일 때만, 해당 쌍 전용 LR로 원본 변이 유무 재판 | **MacroF1 0.4749 / Acc 0.4796** | - | V4 0.4683 대비 +0.0066. KIRC–KIPAN·LGG–GBMLGG 쌍둥이 충돌 제외. test 미사용 |
