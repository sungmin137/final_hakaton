...
| 2026-09-09 | v2_xgb 1차 제출 (test 최초 사용) | 전체 train 학습 → test 추론. twin 규칙 버전 별도 | CV 0.4942 | **0.41** | test 결측 237셀→WT, test 초과변이 5.6%로 train 3배, STES 21.5% 과잉 예측. docs/05_test_inference.md |
...
| 2026-09-09 | v3_xgb + 클래스 배율 후처리 | OOF 좌표상승으로 배율 탐색, 절반 교차확인 | 홀드아웃 +0.012 (0.4663 → 약 0.479) | - | src/common/postprocess/class_scale.py, 규칙 준수(train OOF만) |
